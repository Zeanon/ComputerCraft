...
function update()
    ...
    gui.draw_number(output, 1000000, mon, 9, 4, colors.red)
    output = output - (1000000 * gui.getInteger(output / 1000000))
    gui.draw_number(output, 100000, mon, 13, 4, colors.red)
    output = output - (100000 * gui.getInteger(output / 100000))
    gui.draw_number(output, 10000, mon, 17, 4, colors.red)
    output = output - (10000 * gui.getInteger(output/ 10000))
    gui.draw_number(output, 1000, mon, 21, 4, colors.red)
    output = output - (1000 * gui.getInteger(output / 1000))
    gui.draw_number(output, 100, mon, 25, 4, colors.red)
    output = output - (100 * gui.getInteger(output / 100))
    gui.draw_number(output, 10, mon, 29, 4, colors.red)
    output = output - (10 * gui.getInteger(output / 10))
    gui.draw_number(output, 1, mon, 33, 4, colors.red)
    sleep(0.5)
end
